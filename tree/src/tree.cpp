...
//	RBIntNode* child12 = new RBIntNode(82, "child12");
	...
	rbt.insert(70, "child1");
	rbt.insert(85, "child2");
	rbt.insert(60, "child3");
	rbt.insert(50, "child4");
	rbt.insert(90, "child5");
	rbt.insert(77, "child6");
	rbt.insert(75, "child7");
	rbt.insert(71, "child8");
	rbt.insert(95, "child9");
	rbt.insert(83, "child10");
	rbt.insert(72, "child11");
	rbt.insert(82, "child12");
